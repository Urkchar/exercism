...
def list_contains_list(list_a, list_b):
    """Return True if list_a contains list_b, False otherwise"""

    list_two_length = len(list_b)
    return any(list_a[index:index + list_two_length] == list_b for index in range(len(list_a)))
